                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body table-responsive pl-0 pt-0 pb-0">
                                    ...
                                    <div class="row ">
                                        <div class="col d-flex justify-content-xl-start align-items-center ml-4 mb-2">
                                            <a href="./vincular-profissional-saude.jsp" class="btn btn-success btn-xs">Vincular Profissional de Sa&uacutede</a>
                                        </div>                                  

                                        <div class="col  d-flex justify-content-xl-end align-items-center ml-2 mb-2 mr-4">
                                            <a href="./desvincular-profissional-saude.jsp" class="btn btn-danger btn-xs">Desvincular Profissional de Sa&uacutede</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
